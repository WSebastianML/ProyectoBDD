...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($agencia_id == 1){
        $consulta = "INSERT INTO Socios_01 VALUES ($id, $cc, '$nombre', '$apellido', '$direccion', $telefono, $avaladoPor, $agencia_id)";
        //echo $consulta;
        ...
        $consulta = "INSERT INTO [WIN-D5TV30MDGGJ].[BaseGuayaquil].dbo.Socios_02 VALUES ($id, $cc, '$nombre', '$apellido', '$direccion', $telefono, $avaladoPor, $agencia_id)";
        //echo $consulta;
        $query = $con->getConexion()->prepare($consulta);
        $query->execute();
        header('Location: socio.php');
